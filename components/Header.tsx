...
export default function Header(props: { readonly class?: string }) {
  return (
    <header
      class={twMerge(
        "h-16 px-3 flex items-center justify-between z-50",
        props.class,
      )}
    >
      ...
      <nav class="flex items-center gap-1 sm:gap-2">
        <Link href="/about-me" target="_self" class="p-2 sm:px-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="20px"
            viewBox="0 -960 960 960"
            width="20px"
            class="fill-current sm:mr-2"
          >
          ...
          <span class="hidden sm:inline md:hidden">About</span>
        </Link>
        <Link href="/services" target="_self" class="p-2 sm:px-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="20px"
            viewBox="0 -960 960 960"
        ...
        <Link href="/portfolio" target="_self" class="p-2 sm:px-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="20px"
            viewBox="0 -960 960 960"
        ...
        <Link href="/blogs" target="_self" class="p-2 sm:px-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="20px"
            viewBox="0 -960 960 960"
          ...
          <span class="hidden sm:inline">Blogs</span>
        </Link>
      </nav>
      <button
        command="show-modal"
        commandfor="connect-dialog"
        class="btn btn-sm sm:btn-md btn-outline btn-primary rounded-full px-4 sm:px-6 shrink-0"
        type="button"
      >
        <span class="hidden xs:inline">Let's Connect</span>
        <span class="inline xs:hidden">Connect</span>
      </button>
      <ConnectDialog />
    </header>
  );
